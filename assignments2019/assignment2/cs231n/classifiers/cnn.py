...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        grad_y2, grad_W3, grad_b3 = affine_backward(grad_scores, cache3)
        grad_y1, grad_W2, grad_b2 = affine_relu_backward(grad_y2, cache2)
        grad_X, grad_W1, grad_b1 = conv_relu_pool_backward(grad_y1, cache1)
